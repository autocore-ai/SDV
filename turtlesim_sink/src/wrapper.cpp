...
::rust::repr::PtrLen zenoh$flow$cxxbridge1$run(::zenoh::flow::Context &context, ::std::unique_ptr<::zenoh::flow::State> &state, const ::rust::Vec<::zenoh::flow::Input> *inputs) noexcept {
  void (*run$)(::zenoh::flow::Context &, ::std::unique_ptr<::zenoh::flow::State> &, ::rust::Vec<::zenoh::flow::Input>) = ::zenoh::flow::run;
  ::rust::repr::PtrLen throw$;
  ::rust::behavior::trycatch(
      [&] {
        run$(context, state, ::rust::Vec<::zenoh::flow::Input>(::rust::unsafe_bitcopy, *inputs));
        throw$.ptr = nullptr;
      },
      [&](const char *catch$) noexcept {
        throw$.len = ::std::strlen(catch$);
